...
2. Fecha envio correo Director/Encargado SAE: Fecha en que se envió el correo por parte de Mineduc para la creación de la cuenta.
...
En la siguiente Figura se aprecia la distribución de los **26 SLEP** en régimen al 2025, donde el círculo de color diferente es la ubicación de su SLEP según la cantidad total de establecimientos (eje horizontal) y las vacantes sin asignar (VAS, eje vertical)
